...
A7_catch_adjust$Catch2[which(A7_catch_adjust$Species=="BET")] <- A7_catch_adjust$Catch2[which(A7_catch_adjust$Species=="BET")] * (1-0.18)

A7_catch_adjust$Catch2[which(A7_catch_adjust$Species=="YFT"&A7_catch_adjust$Year==2020)] <- A7_catch_adjust$Catch2[which(A7_catch_adjust$Species=="YFT"&A7_catch_adjust$Year==2020)] * (1+0.13)
...
A7_catch_adjust$Catch2[which(A7_catch_adjust$Species=="SKJ"&A7_catch_adjust$Year==2020)] <- A7_catch_adjust$Catch2[which(A7_catch_adjust$Species=="SKJ"&A7_catch_adjust$Year==2020)] * (1-0.06)
A7_catch_adjust$Catch2[which(A7_catch_adjust$Species=="SKJ"&A7_catch_adjust$Year==2021)] <- A7_catch_adjust$Catch2[which(A7_catch_adjust$Species=="SKJ"&A7_catch_adjust$Year==2021)] * (1+0.04)
...
A7_cps_adjust$CPS2[which(A7_catch_adjust$Species=="BET")] <- A7_cps_adjust$CPS2[which(A7_cps_adjust$Species=="BET")] * (1-0.18)

A7_cps_adjust$CPS2[which(A7_cps_adjust$Species=="YFT"&A7_cps_adjust$Year==2020)] <- A7_cps_adjust$CPS2[which(A7_cps_adjust$Species=="YFT"&A7_cps_adjust$Year==2020)] * (1+0.13)
...
A7_cps_adjust$CPS2[which(A7_cps_adjust$Species=="SKJ"&A7_cps_adjust$Year==2020)] <- A7_cps_adjust$CPS2[which(A7_cps_adjust$Species=="SKJ"&A7_cps_adjust$Year==2020)] * (1-0.06)
A7_cps_adjust$CPS2[which(A7_cps_adjust$Species=="SKJ"&A7_cps_adjust$Year==2021)] <- A7_cps_adjust$CPS2[which(A7_cps_adjust$Species=="SKJ"&A7_cps_adjust$Year==2021)] * (1+0.04)
