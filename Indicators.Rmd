...
```{r Figure 1a}
Figure1 <- paste0("D:/OneDrive - IATTC/Git/Indicators/",year,"/data/")
...
```{r Figure 1}
ggsave((f1a + f1b) / (f1c + f1d),file=paste0(dir,"Figure1.pdf"),height=12,width=12)
ggsave((f1a + f1b) / (f1c + f1d),file=paste0(dir,"Figure1.png"),height=12,width=12)
```
...
ggsave(f2a,file=paste0(dir,"Figure2a.pdf"),height=10,width=12)
ggsave(f2a,file=paste0(dir,"Figure2a.png"),height=10,width=12)
```
...
ggsave(f2b,file=paste0(dir,"Figure2b.pdf"),height=10,width=12)
ggsave(f2b,file=paste0(dir,"Figure2b.png"),height=10,width=12)
```
...
ggsave(f3,file=paste0(dir,"Figure3.pdf"),height=10,width=12)
ggsave(f3,file=paste0(dir,"Figure3.png"),height=10,width=12)
```
...
ggsave(f4,file=paste0(dir,"Figure4.pdf"),height=10,width=12)
ggsave(f4,file=paste0(dir,"Figure4.png"),height=10,width=12)
```
...
f5 <- ggplot(data=DEL_Index) +
  ...
  coord_cartesian(expand = FALSE, ylim = c(0,4),xlim = c(1999,ly+2)) +
  geom_hline(yintercept = 1) +
...
ggsave(f5,file=paste0(dir,"Figure5.pdf"),height=8,width=12)
ggsave(f5,file=paste0(dir,"Figure5.png"),height=8,width=12)
```
...
f6c <- ggplot(data=A9) +
  ...
  geom_hline(yintercept = 1) +
  coord_cartesian(ylim = c(0,2),xlim=c(2000,ly))

ggsave(f6a / f6b / f6c,file=paste0(dir,"Figure6.pdf"),height=12,width=8)
ggsave(f6a / f6b / f6c,file=paste0(dir,"Figure6.png"),height=12,width=8)
```
...
```{r Figure 7}
ggsave((f7a + f7b) / (f7c + f7d),file=paste0(dir,"Figure7.pdf"),height=12,width=16)
ggsave((f7a + f7b) / (f7c + f7d),file=paste0(dir,"Figure7.png"),height=12,width=16)
```
