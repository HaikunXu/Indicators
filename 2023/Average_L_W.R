...
estone<-read.table("D:/OneDrive - IATTC/IATTC/2023/SAC14/SSIs/ESTONE.txt",header=F,sep=",")
...
write.csv(cbind(seq(2000,2022),as.vector(tmpclyft.del),as.vector(tmpclskj.del),as.vector(tmpclbet.una),as.vector(tmpclyft.una),as.vector(tmpclskj.una),as.vector(tmpclbet.obj),as.vector(tmpclyft.obj),as.vector(tmpclskj.obj)),file="D:/OneDrive - IATTC/IATTC/2023/SAC14/SSIs/average length_yr x setype_2000-2022.csv", row.names = FALSE)
...
write.csv(cbind(seq(2000,2022),tmp.del[,2:3],tmp.una,tmp.obj),file="D:/OneDrive - IATTC/IATTC/2023/SAC14/SSIs/average weight_yr x setype_2000-2022.csv", row.names = FALSE)
